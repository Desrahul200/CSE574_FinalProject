...
class CarlaRouteEnv(gym.Env):
    ...
    def __init__(self, host="127.0.0.1", port=2000,
        ...
        if start_carla:
            ...
            # carla_path = os.path.join(os.environ["CARLA_ROOT"], "CarlaUE4.exe")
            #change path
            carla_path = "C:/Users/aasha/Documents/School/ASU/Masters/CSE574/FinalProject/CarlaSimulator/CARLA_0.9.13/WindowsNoEditor/CarlaUE4.exe"
